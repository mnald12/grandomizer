	...
	methods : {
		setData(){
			...
			for(let i = 0; i < 19; i++){
				...
				color2.push('radial-gradient(' + rt + rsc + rat + fclr2.toString() + ')')
			}
			this.$emit('set-data', color2)
		},
		minus(){
